    ...
    <div className="filter-right">
      <div className="feature-btn">
        <div className="feature1">
          <img src="img/open-menu 1.png" alt="" />
        </div>
        <div className="feature1">
          <img src="img/ic_gridView.png" alt="" />
        </div>
        <div className="feature1">
          <img src="img/ic_sidebarView.png" alt="" />
        </div>
      </div>
      <div className="feature-btn g">
        <img src="img/filter (3) 1.png" alt="" />
        <div>Categories</div>
      </div>
      <div className="feature-btn g c">
        <img src="img/Group.png" alt="" />
        <div>Newest</div>
        <img className="f" src="img/right-chevron (1) 1 (1).png" alt="" />
      </div>
    </div>
  </div>
